<section class="page-section bg-dark" id="home">
	<div class="container">
		<h2 class="text-center">Paket & Hotel</h2>
		...
		?>
			<div class="card d-flex w-100 rounded-0 mb-3 package-item">
				...
				<div class="w-100 d-flex justify-content-between">
					...
					<a href="./?page=view_package&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning">llhat Paket & Hotel <i class="fa fa-arrow-right"></i></a>
				</div>
				</div>
			</div>
		<?php endwhile; ?>
